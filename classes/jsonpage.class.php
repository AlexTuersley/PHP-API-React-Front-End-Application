...
class JSONpage {
  ...
  */
   ...
   * @param $name is the name of an author that has been searched if there is no name defaults to list of all authors
   * @return string json query results 
   */ 
  private function json_authors($name = ""){
  if($name != ""){
